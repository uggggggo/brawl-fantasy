...
# --- CONFIGURAZIONE PAGINA E STILE GRAFICO ---
st.set_page_config(page_title="Brawl Fantasy - Tournaments", page_icon="🎮", layout="centered")

# Stile CSS pulito e minimale (senza forzature complesse sui componenti nativi)
st.markdown("""
    <style>
    ...
    /* Testo generale bianco, escludendo i campi di input */
    ...
    /* Campi di input e pulsanti standard */
    .stTextInput input {
...
# --- INTESTAZIONE COMUNE (Titolo, Sottotitolo e Nota Dark Mode in Inglese) ---
st.title("🎮 Brawl Fantasy")
st.subheader("🔥 Tournament & Competition Management")

# Nota informativa in inglese inserita subito sotto i titoli in ogni pagina
...
# ==========================================
# 1. MODALITÀ HOMEPAGE (CREAZIONE ROSA)
# ==========================================
    ...
    if not team_disponibili_giornata_list:
        ...
        nome_fissato = res_device_user[0] if res_device_user else ""
...
# ==========================================
# 2. MODALITÀ CLASSIFICA GENERALE E DI GIORNATA
# ==========================================
